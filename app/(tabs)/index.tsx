...
const QUICK_ACTIONS = [
        { id: '1', title: 'AI Quote Builder', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'Material AI', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Project Timeline', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Client Portal', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Cost Analytics', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'construction');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>Smart construction quoting & management</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — construction</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask BuildQuote AI anything...`}
