...
// BuildQuote | Smart construction quoting and management
...
const ACTIONS = [
  { id: '1', title: 'AI Quote Builder', icon: 'sparkles-outline' },
  { id: '2', title: 'Material AI', icon: 'sparkles-outline' },
  { id: '3', title: 'Project Timeline', icon: 'sparkles-outline' },
  { id: '4', title: 'Client Portal', icon: 'sparkles-outline' },
  { id: '5', title: 'Cost Analytics', icon: 'sparkles-outline' },
];
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>Smart construction quoting and management</Text>
        </View>
