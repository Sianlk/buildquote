...
// BuildQuote — AI Agents & Workforce
...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('AI Quote Builder');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: construction</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['AI Quote Builder','Material AI','Project Timeline','Client Portal','Cost Analytics'].map((f) => (
            <TouchableOpacity
              key={f}
