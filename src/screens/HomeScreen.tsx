    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>From Blueprint to Quote in Minutes</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>Instant AI Estimates</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>Material Takeoffs</Text>
        </View>
        <View key="2" style={styles.featureCard}>
          <Text style={styles.featureText}>Client Proposals</Text>
        </View>
