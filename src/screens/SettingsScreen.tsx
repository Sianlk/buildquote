  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <SettingRow label='Subscription' value='Manage' action={() => open('https://buildquote.sianlk.com/subscription')} />
        <SettingRow label='Change Password' action={() => {}} />
        <SettingRow label='Two-Factor Authentication' action={() => {}} />
        <Text style={styles.sectionHeader}>SUPPORT</Text>
        <SettingRow label='Help Centre' action={() => open('https://buildquote.sianlk.com/support')} />
        <SettingRow label='Privacy Policy' action={() => open('https://buildquote.sianlk.com/privacy')} />
        <SettingRow label='Terms of Service' action={() => open('https://buildquote.sianlk.com/terms')} />
