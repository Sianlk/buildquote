// AI Workforce Agent — BuildQuote
// Autonomous AI worker for construction
...
// Specialised AI agents for construction
const AGENT_PERSONAS = {
  analyst: {
    name: 'BuildQuote Analyst',
    role: `Expert construction analyst with deep knowledge of cost estimation, material calculation, project scheduling.`,
    capabilities: ["AI Quote Builder", "Material AI", "Project Timeline", "Client Portal", "Cost Analytics"],
  },
  advisor: {
    name: 'BuildQuote Advisor',
    role: `Senior construction advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'BuildQuote Automator',
    role: `Autonomous construction task executor and workflow manager.`,
