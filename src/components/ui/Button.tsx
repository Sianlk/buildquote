...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#F59E0B' },
  v_secondary: { backgroundColor: '#FCD34D33' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#F59E0B' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#D97706', borderWidth: 1, borderColor: '#FCD34D' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#D97706' },
  lv_outline:   { color: '#F59E0B' },
  lv_ghost:     { color: '#F59E0B' },
