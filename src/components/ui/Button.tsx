...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#F59E0B' },
  variant_secondary: { backgroundColor: '#FCD34D33' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#F59E0B' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#D97706', borderWidth: 1, borderColor: '#FCD34D' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#D97706' },
  label_outline:   { color: '#F59E0B' },
  label_ghost:     { color: '#F59E0B' },
