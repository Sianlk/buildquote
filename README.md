...
<img src="assets/graphics/icon-1024.svg" width="120" alt="BuildQuote Icon" />

# BuildQuote

### From Blueprint to Quote in Minutes

[![CI](https://github.com/Sianlk/buildquote/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/buildquote/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/buildquote/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/buildquote/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://buildquote.app)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**construction, AI, cost estimation**

[Website](https://buildquote.app) · [Privacy Policy](https://buildquote.app/privacy) · [Support](https://buildquote.app/support)
...
**BuildQuote** — From Blueprint to Quote in Minutes
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to construction
