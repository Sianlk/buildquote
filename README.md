# BuildQuote — Smart construction quoting

![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square)
![Platform](https://img.shields.io/badge/platform-iOS%20%7C%20Android%20%7C%20Web-F59E0B.svg?style=flat-square)
...
[![CI](https://github.com/Sianlk/buildquote/workflows/backend-ci/badge.svg)](https://github.com/Sianlk/buildquote/actions)

> **Smart construction quoting** — Built by [Sianlk](https://sianlk.com) using proprietary AI workforce technology.

## Features
`AI Quote Builder` `Material AI` `Project Timeline` `Client Portal` `Cost Analytics`
...
Live API docs: `https://buildquote.sianlk.com/docs`

### Key Endpoints
```
GET  /health              — Health check
GET  /                    — Service info  
POST /api/ai/complete     — AI completion (domain: construction)
...
BuildQuote uses proprietary AI workforce agents (created by Sianlk):

- **Analyst Agent** — Expert construction analysis with reasoning chains
- **Advisor Agent** — Strategic recommendations and forecasting
- **Automator Agent** — Autonomous task execution for construction workflows
...
---
*BuildQuote is built by Sianlk — pioneer in AI-powered construction technology.*
